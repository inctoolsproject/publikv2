...
Bots=[mid,"u0afddc8120f1a2bc94652cd31622c00f"]
...
wait = {
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"Thanks Foradd",
    "lang":"JP",
    "comment":"Thanks for add ^_^\nDon't Forget add My Creator:https://line.me/ti/p/~saifulloh13",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#--------------------------
          ...
          if msg.from_in admin:  
            eltime = time.time() - mulai
            van = "Bot sudah berjalan selama "+waktu(eltime)
            lang = 'id'
            tts = gTTS(text=van, lang=lang)
            tts.save("hasil.mp3")
